cmd_scripts/kconfig/conf.o := /home/essele/dev/buildroot/output/host/usr/bin/ccache /usr/bin/gcc -Wp,-MD,scripts/kconfig/.conf.o.d    -I/usr/include/ncursesw -DCURSES_LOC="<curses.h>"  -DNCURSES_WIDECHAR=1 -DLOCALE   -c -o scripts/kconfig/conf.o scripts/kconfig/conf.c
