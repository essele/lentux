cmd_scripts/kconfig/zconf.tab.o := /home/essele/dev/buildroot/output/host/usr/bin/ccache /usr/bin/gcc -Wp,-MD,scripts/kconfig/.zconf.tab.o.d    -I/usr/include/ncursesw -DCURSES_LOC="<curses.h>"  -DNCURSES_WIDECHAR=1 -DLOCALE  -Iscripts/kconfig -c -o scripts/kconfig/zconf.tab.o scripts/kconfig/zconf.tab.c
